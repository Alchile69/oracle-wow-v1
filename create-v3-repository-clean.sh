...
echo "🚀 CRÉATION REPOSITORY ORACLE PORTFOLIO V3 - VERSION PROPRE"
echo "=========================================================="
...
# Copier tous les fichiers du repository actuel (sans .git)
echo "📋 Copie des fichiers..."
rsync -av --exclude='.git' --exclude='node_modules' --exclude='dist' --exclude='.vercel' ../oracle-portfolio-v2-6-1-hybride-secteurs/ .
...
echo "🎉 REPOSITORY V3 CRÉÉ PROPREMENT !"
echo "=================================="
